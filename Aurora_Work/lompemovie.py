...
def requester(sc_collection, measurement, residual, sampling_step=None, t0, DT, **kwargs):
    try:
...
def Lompe(t0, DT):
    ...
    def SwarmB():
        ...
        for i in range(3):
            ...
            print((dsB["Radius"].to_numpy()-6.371e6)/1e3, 'km radi')
            ...
            swarmmags.append(lompe.Data(Bused*1e-9,coords, datatype='space_mag_full', error=5e-9,iweight=0.6))
